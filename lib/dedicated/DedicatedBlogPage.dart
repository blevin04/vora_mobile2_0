...
class Dedicatedblogpage extends StatefulWidget {
  final blogId;
  const Dedicatedblogpage({super.key,required this.blogId});

  @override
  State<Dedicatedblogpage> createState() => _DedicatedblogpageState();
}
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                      ...
                      width: 200,
                       child: TextField(
                        ...
                        minLines: null,
                            ...
                            IconButton(onPressed: (){
                              commentpost(widget.blogId, blogcommentcontroller.text);
                ...
                StreamBuilder(
                  stream: firestore.collection("posts").doc(widget.blogId).snapshots(),
                                ...
                                ListTile(
                                  ...
                                  trailing: Badge(
                                   ...
                                   // alignment: Alignment.bottomRight,
                                    ...
                                    child: IconButton(onPressed: (){
                                      likecomment("posts", widget.blogId, postCommentKeys[index]);
